...
const phone = form.querySelector('#user_phone');
const message = form.querySelector('#user_message');
const send = form.querySelector('#send_form');
const thanks = form.querySelector('.send_thanks')
